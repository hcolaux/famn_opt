...
famn.param['export_filepath'] = '', # (Optionnal) Path where all output files are exported.
# ----------------------------------------------------------------------------
# Transfer parameters
...
famn.param['max_nopulses'] = int(30) # Maximum number of pulses that the program is allowed to output.
...
famn.param['maxdt_ratio'] = int(20) # Ratio between MAS period and maxdt in SIMPSON.
famn.param['num_cores'] = int(0) # Number of cores on which the optimisation is programmed
